  ...
  return (
    <div className="fixed inset-0 z-[60] grid place-items-center bg-black/70 backdrop-blur-sm">
      <div className="panel p-8 text-center max-w-sm mx-4 animate-pop">
        ...
        <p className="text-sm text-muted mt-2">{t('rankedsearch.subtitle')} · {t(TYPE_LABEL_KEY[queue.matchType])}</p>
        ...
        <p className="text-xs text-muted mt-2">{t('rankedsearch.playerCount', { size: queue.size, needed: queue.needed })}</p>
